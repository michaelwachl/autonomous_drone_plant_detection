...
class Tello(object):
    ...
    def __init__(self, port=9000):
        ...
        ## added by wachl, publish state to ros
        self.pub_connection = rospy.Publisher('connection_state', String, queue_size=1, latch=True)
        ##
    ...
    def __state_machine(self, event, sender, data, **args):
        ...
        if cur_state != self.state:
            ## added by wachl, publish state to topic
            self.pub_connection.publish(self.state.getname())
            ##
